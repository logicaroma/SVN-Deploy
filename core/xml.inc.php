...
function svndeploy_simplexml_to_array($xml, 
                $flattenValues=true,
    ...
    foreach($xml->children() as $elementName => $child){
        $value = svndeploy_simplexml_to_array($child, $flattenValues, $flattenAttributes, $flattenChildren, $valueKey, $attributesKey, $childrenKey);
